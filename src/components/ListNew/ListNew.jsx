...
class ListNew extends React.Component{
    constructor(props){
        super(props);
        this.url = `${props.base_url}users/${localStorage.getItem('user_id')}/lists`;
    ...
    handleSubmit(e){
        ...
        if(description){data["due_date"] = description;}
            ...
            <div className={styles['add-list-container']}>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className={styles['input-container']}>
                        ...
                        <input type="datetime-local" name="due_date" defaultValue={new Date().toISOString().slice(0,-1)}/>
                    </div>
                    <div className={styles['input-container']}>
